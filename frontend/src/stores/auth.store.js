    ...
    actions: {
        async login(email, password) {
            ...
            if (res.status === 200) {
                ...
                console.log('[auth.store.js] Pinia Name: ', this.full_name)
                ...
                localStorage.setItem('full_name', JSON.stringify(res.data.full_name));
                ...
                console.log('[auth.store.js] localStorage Name: ', localStorage.getItem('full_name'))
